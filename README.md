...
Cuando tu navegador detecte el archivo como virus, selecciona el boton de 3 puntos y conservar, una vez hecho todo lo anterior mencionado la descarga se acompletara de forma segura.\
